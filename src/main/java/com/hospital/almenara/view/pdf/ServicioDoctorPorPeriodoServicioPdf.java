...
public class ServicioDoctorPorPeriodoServicioPdf {
    ...
    public ByteArrayOutputStream getListDoctors(List<ServicioDoctor> servicioDoctorList, AnioAcademico anioAcademicoConsulted, Long serviceId) {
...
//            table.setWidths(new int[]{1, 3, 6, 6, 6, 6, 3, 3, 4, 10, 2, 6, 5});
            ...
            Paragraph subtitle = new Paragraph("Relación de Médicos Residentes de otras Especialiades que rotarán por sus servicios "+anioAcademicoConsulted.getMesInicio()+" "+anioAcademicoConsulted.getAnioInicio()+" - "+anioAcademicoConsulted.getMesFinal()+" "+anioAcademicoConsulted.getAnioFinal(),
